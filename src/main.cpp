...
void testNumberTheory() {
    ...
    std::cout << "\n";
    std::cout << "Fibonacci of 10: " << fastFibonacci(10) << "\n";
...
void testStatistics() {
    ...
    std::cout << "PDF at 3.0: " << probabilityDensityFunction(3.0, mean(data), standardDeviation(data)) << "\n";
    std::cout << "CDF at 3.0: " << cumulativeDistributionFunction(3.0, mean(data), standardDeviation(data)) << "\n";
    std::cout << "Inverse CDF at 0.5: " << inverseCumulativeDistributionFunction(0.5, mean(data), standardDeviation(data)) << "\n";
    std::cout << "Normal Distribution at 3.0: " << normalDistribution(3.0, mean(data), standardDeviation(data)) << "\n";
    std::cout << "Inverse Normal Distribution at 0.5: " << inverseNormalDistribution(0.5, mean(data), standardDeviation(data)) << "\n";
    std::cout << "Area under Normal Distribution between 2.0 and 4.0: " << areaUnderNormalDistribution(2.0, 4.0, mean(data), standardDeviation(data)) << "\n";
}
