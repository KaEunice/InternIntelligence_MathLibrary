...
namespace Math_lib{
    ...
    fastFibonacci(T n){
        ...
        T base[2][2] ={{1, 1},{1, 0}};
        T result[2][2] ={{1, 0},{0, 1}};

        while (n > 0){
            if (n % 2 == 1){
                T a = result[0][0] * base[0][0] + result[0][1] * base[1][0];
                T b = result[0][0] * base[0][1] + result[0][1] * base[1][1];
                T c = result[1][0] * base[0][0] + result[1][1] * base[1][0];
                T d = result[1][0] * base[0][1] + result[1][1] * base[1][1];

                result[0][0] = a; result[0][1] = b;
                result[1][0] = c; result[1][1] = d;
            }
            T a = base[0][0] * base[0][0] + base[0][1] * base[1][0];
            T b = base[0][0] * base[0][1] + base[0][1] * base[1][1];
            T c = base[1][0] * base[0][0] + base[1][1] * base[1][0];
            T d = base[1][0] * base[0][1] + base[1][1] * base[1][1];

            base[0][0] = a; base[0][1] = b;
            base[1][0] = c; base[1][1] = d;
